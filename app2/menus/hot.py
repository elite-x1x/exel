...
def show_hot_menu():
    ...
    while in_hot_menu:
        ...
        with live_loading("Memuat data...", theme):
            hot_packages = merge_hot1("https://raw.githubusercontent.com/elite-x1x/multi/refs/heads/main/hot_data/hot.json")
...
def show_hot_menu2():
    ...
    while in_hot_menu2:
        ...
        with live_loading("Memuat data...", theme):
            hot_packages = merge_hot2("https://raw.githubusercontent.com/elite-x1x/multi/refs/heads/main/hot_data/hot2.json")
